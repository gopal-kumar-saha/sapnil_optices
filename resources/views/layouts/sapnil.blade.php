...
<head>
    ...
    <title>Sapnil_Optices</title>
    <link rel="stylesheet" href="{{ asset('sapnil_assets/css/bootstrap.min.css') }}">
    <link rel="stylesheet" href="{{ asset('sapnil_assets/css/font-awesome.min.css') }}">
    <link rel="stylesheet" href="{{ asset('sapnil_assets/css/slick.css') }}">
    <link rel="stylesheet" href="{{ asset('sapnil_assets/css/meanmenu.min.css') }}">
    <link href="https://fonts.googleapis.com/css?family=Open+Sans:400,600,700" rel="stylesheet">
    <link href="https://fonts.googleapis.com/css?family=Raleway:400,500,600,700" rel="stylesheet">
    <link href="https://fonts.googleapis.com/css?family=Sacramento" rel="stylesheet">
    <link rel="stylesheet" href="{{ asset('sapnil_assets/css/style.css') }}">
    <link rel="stylesheet" href="{{ asset('sapnil_assets/css/media.css') }}">
</head>
<body>
  <!-- Header Part Start -->
   <header id="header">
...
<nav class="mobile-menu hidden">
  <a href="index.html">
      <img src="{{ asset('sapnil_assets/images/logo.png') }}" alt="logo">
  </a>
   <ul>
        <li class="">
            <a href="{{ url('/') }}">
      ...
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.html">
              <img src="{{ asset('sapnil_assets/images/logo.png') }}" alt="logo" class="img-responsive">
          </a>
        </div>
...
<!--            <li><a href="blog-grid-view.html">Blog</a></li>-->
            <li class="nav-item dropdown">
                {{-- <a class="nav-link dropdown-toggle" href="{{ url('/index') }}" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  Home
                </a> --}}
                  ...
                  <div class="items text-left">
                      ...
                      <div class="item-choose-main">
                          <div class="item-choose">
                              <ul>
                                  <li>
                                      <img src="{{ asset('sapnil_assets/images/items1.png') }}" alt="item1" class="img-responsive">
                                  </li>
                                  <li>
                          ...
                          <div class="item-choose">
                              <ul>
                                  <li>
                                      <img src="{{ asset('sapnil_assets/') }}images/items2.png" alt="item1" class="img-responsive">
                                  </li>
                                  <li>
                                      <h3>T-shirt for Women</h3>
                                      <p>Price : $ 99.00</p>
...
<!-- Footer Part Start -->
                   ...
                   <div class="footer-main">
                       <div class="col-md-3 col-sm-6">
                           <div class="footer-logo">
                               <a href="#"><img src="{{ asset('sapnil_assets/images/footer-logo.png') }}" alt="footer-logo" class="img-responsive"></a>
           ...
           <div class="row">
               ...
               <div class="col-md-6 col-xs-12">
                   <div class="payment text-right">
                       <img src="{{ asset('sapnil_assets/images/card1.png') }}" alt="card" class="img-responsive">
                       <img src="{{ asset('sapnil_assets/images/card2.png') }}" alt="card" class="img-responsive">
                       <img src="{{ asset('sapnil_assets/images/card3.png') }}" alt="card" class="img-responsive">
                       <img src="{{ asset('sapnil_assets/images/card4.png') }}" alt="card" class="img-responsive">
                       <img src="{{ asset('sapnil_assets/images/card5.png') }}" alt="card" class="img-responsive">
                   </div>
               </div>
           </div>
       </div>
   ...
   <!-- Footer Bottom End -->   
    ...
    <script src="{{ asset('sapnil_assets/js/jquery-1.12.4.min.js') }}"></script>
    <script src="{{ asset('sapnil_assets/js/bootstrap.min.js') }}"></script>
    <script src="{{ asset('sapnil_assets/js/slick.js') }}"></script>
    <script src="{{ asset('sapnil_assets/js/jquery.countdown.min.js') }}"></script>
    <script src="{{ asset('sapnil_assets/js/jquery.meanmenu.min.js') }}"></script>
    <script src="{{ asset('sapnil_assets/js/main.js') }}"></script>
</body>
</html>